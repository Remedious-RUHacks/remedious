...
class AcademicLogin extends StatefulWidget {
  @override
  _AcademicLoginState createState() => _AcademicLoginState();
}

class _AcademicLoginState extends State<AcademicLogin> {
              ...
              children: <Widget>[
                ...
                RichText(text: TextSpan(
                  ...
                  children: <TextSpan>[
                    ...
                    TextSpan(
                      text: "Here",
                        recognizer: new TapGestureRecognizer()..onTap = () => Navigator.pushNamed(context, academicSignUpRoute),
                        style: TextStyle(
                        color: blue1,
                        fontSize: 16
                      )
