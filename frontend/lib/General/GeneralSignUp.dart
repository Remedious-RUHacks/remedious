              ...
              children: <Widget>[
                ...
                InkWell(
                  onTap: () async{
                    ...
                    Navigator.pushNamed(context, onboardingRoute,arguments: GeneralUser(firstName: firstName.text,lastName: lastName.text,email: emailController.text,password: passController.text,symptoms: <Symptom>[Symptom("A high temperature")],age: 23,gender: "Male",ethnicBackground: "Indian"));
                  },
                  child: Container(
                    height: 40,
                    width: 140,
